...
[extra] author = "arkanoider" img = "/img/Data_Encryption.jpg" summary = "Identity keys are now detached from users - orders identities keys will be encrypted so also in case of database leak, no relation can be found between users and orders" +++
